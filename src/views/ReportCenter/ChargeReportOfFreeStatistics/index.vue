<template>
  <div class="ChargeReportOfFreeStatistics">
    ...
    <div class="main-container">
      <div class="toolbar" style="outline:none" tabindex="0" @keydown="enterEvents($event)">
        <el-form :inline="true" size="mini" :model="tableQuery" class="demo-form-inline">
            ...
            <el-form-item label="农业户口：">
              <el-select ref="select1" v-model="tableQuery.ncFlag" clearable size="mini">
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        <el-table highlight-current-row v-if="tableShow" :max-height="maxHeight" show-summary :summary-method='getTotal' stripe border :data="tableData" class="change-tables-table">
          ...
          <el-table-column prop="areaName" min-width="150" label="郊区">
          </el-table-column>

          <el-table-column :label="accountPeriod" align="center">
            <el-table-column prop="water" min-width="150" label="水量（吨）" align="right">
            </el-table-column>

            <el-table-column prop="money" min-width="150" label="水费金额（元）" align="right">
            </el-table-column>
          </el-table-column>

          <el-table-column prop="notTaxMoney" min-width="150" label="不含税水费金额" align="right">
          </el-table-column>

          <el-table-column prop="vat" min-width="100" label="应交税金增值税" align="right">
          </el-table-column>
        </el-table>
...
export default {
  name: "ChargeReportOfFreeStatistics",
  components: {
  ...
  data() {
    return {
      ...
      crumbsData: {
        //面包屑
        titleList: [{ title: "收费管理报表" }, { title: "免税统计报表" }]
      },
      // 查询条件对象
      tableQuery: {
        area: '',// 营业区域
  ...
  mounted() {
    ...
    this.common.changeTable(this, ".ChargeReportOfFreeStatistics .main-container", [
      ".ChargeReportOfFreeStatistics .toolbar",
      ".ChargeReportOfFreeStatistics .block"
    ])
  },
  methods: {
    enterEvents(e){
    ...
    init() {
      if (!this.tableQuery.area) {
        ...
        return
      }else if(!this.tableQuery.startDate || !this.tableQuery.endDate ){
        this.$message.error('收费日期不能为空！')
        return
      }
      let _this = this
      let params = {
        "busicode": "AreaWaterProceedsReport",
      ...
      this.$api.fetch({
        ...
        this.accountPeriod = res.total.accountPeriod
    ...
    exportExcel() {
      let params = {
        "busicode": "AreaWaterProceedsReportExport",
