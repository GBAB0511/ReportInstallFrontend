        ...
        <div class="kl-table" :style="{height: maxHeight + 'px'}">
          <el-table highlight-current-row v-if="tableShow" :max-height="maxHeight" stripe border show-summary :summary-method='getTotal' :data="tableData.list" class="OtherReportOfCustomerInfoSummary-table">
            ...
            <el-table-column type="index" label="NO." width="50" fixed="left" :index="indexMethod">
             ...
             <el-table-column prop="waterTypeName" min-width="100" label="用水类型">
            </el-table-column>

            <el-table-column prop="totalAmount" min-width="70" label="用户总数" align="right">
            </el-table-column>

            <el-table-column prop="bigBoreAmount" min-width="100" label="大口径用户数" align="right">
            </el-table-column>

            <el-table-column prop="smallBoreAmount" min-width="100" label="小口径用户数" align="right">
            </el-table-column>

            <el-table-column prop="bigBoreRaito" min-width="100" label="大口径占比" align="right">
            </el-table-column>

            <el-table-column prop="intelligentMeterAmount" min-width="100" label="智能水表用户数" align="right">
            </el-table-column>

            <el-table-column prop="notIntelligentMeterAmount" min-width="110" label="非智能水表用户数" align="right">
            </el-table-column>

            <el-table-column prop="intelligentMeterRatio" min-width="100" label="智能表占比" align="right">
            </el-table-column>
<!-- 
            <el-table-column prop="arrearageAmount" min-width="80" label="欠费占比">
            </el-table-column> -->

            <el-table-column prop="wechatAmount" min-width="100" label="微信客户关注数" align="right">
            </el-table-column>
            <el-table-column prop="internetHallAmount" min-width="100" label="网厅客户注册数" align="right">
            </el-table-column>
...
export default {
  name: "OtherReportOfCustomerInfoSummary",
  components: {
       autoTree
  },
  data() {
    return {
      ...
      //面包屑
      crumbsData: {
        titleList: [{ title: "其它报表" }, { title: "用户统计表" }]
      },
      tableShow: false,
      maxHeight: 0,
      waterTypeNo:'',
  ...
  methods: {
    ...
    exportExcel() {
      let params = {
        "busicode": "CtmSummaryReportExport",
