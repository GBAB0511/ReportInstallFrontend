<template>
  <!-- 拆表 -->
  <div class="ChargeReportOfProductOperation">
    ...
    <div v-if="indexShow" class="index-page">
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        <el-table highlight-current-row v-if="tableShow" :max-height="maxHeight" stripe border   :data="tableData" class="ChargeReportOfProductOperation-table">
...
<script>
export default {
  name: "ChargeReportOfProductOperation",
  components: {
  ...
  mounted() {
    ...
    this.common.changeTable(this, ".ChargeReportOfProductOperation", [
      ".ChargeReportOfProductOperation .toolbar",
      ".ChargeReportOfProductOperation .block",
      '.ChargeReportOfProductOperation .bread-contain'
    ]);
  },
  methods: {
    enterEvents(e){
    ...
    init() {
      ...
      let params = {
        busicode: "ProductOperationReport",
    ...
    exportExcel() {
      let params = {
        "busicode": "ProductOperationReportExport",
...
$imgWidth: 200px;
$theme-color: #297acc;
.ChargeReportOfProductOperation {
  width: 100%;
  height: 100%;
  .index-page {
