<template>
  ...
  <div class="ApartAccount">
    ...
    <div v-if="indexShow" class='indexPage' style="height:100%">
      ...
      <div class="bread-contain">
        ...
        <div class="bread-contain-right">
          <el-button icon="el-icon-plus" size="mini" type="primary" @click.native="add">拆户</el-button>
        </div>
      </div>
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        <el-table highlight-current-row v-if="tableShow" :max-height="maxHeight" stripe border :data="tableData.list" class="change-tables-table">
          ...
          <el-table-column prop="processStateName" min-width="70" label="进度"></el-table-column>
          ...
          <el-table-column prop="certNo" min-width="130" label="拆户证件号码" show-overflow-tooltip>
          </el-table-column>
    ...
    <div v-else style="height:100%">
      ...
      <ApartAccountDetail  v-if="!indexShow" ref="childList" :billStute="status" :billNo="billNo" :id="id"></ApartAccountDetail>
    </div>
  </div>
</template>
<script>
import ApartAccountDetail from './ApartAccountDetail'
export default {
  name: "ApartAccount",
  components: {
    ApartAccountDetail
  ...
  methods: {
    ...
    init() {
      ...
      this.$api.fetch({
        ...
        this.$nextTick(() => {
        this.common.changeTable(this, '.ApartAccount .indexPage', 
