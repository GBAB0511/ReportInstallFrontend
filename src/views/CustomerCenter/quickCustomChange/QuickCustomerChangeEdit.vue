<template>
  <div class="QuickCustomerChangeEdit ">
    ...
    <el-form size="mini" class="formBill" :inline="true" :disabled="NotDisabled" :model="formData" label-width="130px" :rules="rules" ref="ruleFormV" @submit.native.prevent>

      <el-form-item label="用户编号：" v-if="searchBtnShow" class="width450" style="margin-top: 20px">
        <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" class="read-only" v-model="searchUserNum" placeholder="请输入户号" @change="initUserNo" clearable>
    ...
    initUserNo () {
      ...
      this.$api
        ...
        .then(res => {
          ...
          console.log('userSelect res', res)
          this.getFormData(res);
