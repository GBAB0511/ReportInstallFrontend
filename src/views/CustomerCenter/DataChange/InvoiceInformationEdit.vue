    ...
    <el-tabs type="border-card" v-model="tabName">
      <el-tab-pane label="变更前" name="before">
        <el-form class="backfillSubmitForm" :inline="true" :model="countManagementEditForm" label-width="160px" ref="ruleForm" :rules="rules">
          ...
          <el-form-item label="发票类型：" prop="desc">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="countManagementEditForm.desc" placeholder="" disabled class="read-only"></el-input>
          ...
          <el-form-item label="开户行：">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="countManagementEditForm.bankCountNum" placeholder="" disabled class="read-only"></el-input>
          </el-form-item>
          <el-form-item label="银行账号：">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="countManagementEditForm.bankCountNum" placeholder="" disabled class="read-only"></el-input>
          </el-form-item>
          <el-form-item label="投递方式：">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="countManagementEditForm.bankCountNum" placeholder="自取" disabled class="read-only"></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="变更后" name="after">
        <el-form class="backfillSubmitForm" :inline="true" :model="countManagementEditForm" label-width="160px" ref="ruleForm" :rules="rules">
          ...
          <!-- <el-form-item label="发票类型：" prop="desc" class="selectCheck"> -->
          <el-form-item label="发票类型：" prop="desc">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="countManagementEditForm.desc" placeholder=""></el-input>
