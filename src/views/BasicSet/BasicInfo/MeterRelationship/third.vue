  ...
  <div class="third">
    <div class="third">
      ...
      <div class='third-center'>
        <div class="toolbar">
          <el-form :inline="true" size="mini" :model="tableQuery" class="demo-form-inline" @submit.native.prevent>
            ...
            <el-checkbox v-model="tableQuery.checked" style="margin-left: 5%;">存在子表</el-checkbox>
            <el-form-item label="">
        ...
        <div class="block">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="tableQuery.page" :page-sizes="[100, 500, 1000]" :page-size="tableQuery.pageCount" :pager-count="3" layout="total, sizes, prev, pager, next, jumper" :total="tableData.total">
          </el-pagination>
        </div>
      </div>
      <div class='third-left'>
        ...
        <div class="block">
          <el-pagination @size-change="handleSizeChange1" @current-change="handleCurrentChange1" :current-page="tableQuery1.page" :page-sizes="[100, 500, 1000]" :page-size="tableQuery1.pageCount" :pager-count="3" layout="total, sizes, prev, pager, next, jumper" :total="tableData1.total">
          </el-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  mounted () {
    ...
    this.init();
    this.$nextTick(() => {
      this.common.changeTable(this, '.third',
        ['.third .toolbar', '.third .block'])
    })
  },
  methods: {
    inputMe(e){
