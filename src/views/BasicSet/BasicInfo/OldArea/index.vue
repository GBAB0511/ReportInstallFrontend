  ...
  <div class="OldArea">
      <div class="bread-contain">
        ...
        <div class="bread-contain-right" v-if="EditVisible">
            <el-button size="mini" type="primary" @click="submitForm('OldAreaEdit')">保存</el-button>
      ...
      <OldAreaEdit v-show="EditVisible" ref="OldAreaEdit"></OldAreaEdit>
...
<script>
import OldAreaEdit from "./OldAreaEdit";
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.common.changeTable(this, ".OldArea .company-right", [
        ".OldArea .toolbar",
        ".OldArea .block"
      ]);
  ...
  methods: {
    ...
    add(val,item) {
      ...
      if (val === "add") {
        this.formType = 'add'
        this.$refs.OldAreaEdit.editData({
          areaNo: "",
          areaName: "",
          sortNo: "",
          status: 1,
          ...
          this.common.chargeObjectEqual(this,this.formData,'set','OldAreaEdit');
      }else if (val === "addnext" ) {
        ...
        this.$api
          ...
          .then(res => {
            this.$refs.OldAreaEdit.editData(res);
            this.common.chargeObjectEqual(this, res, "set", "OldAreaEdit");
          });
      }
    },
    // 列表的NO列
    ...
    // 返回
    handleClose() {
      this.$refs.OldAreaEdit.handleClose();
    },
    // 树的点击
    backAbodeData(val) {
      if(val.id=='0'){
    ...
    //保存按钮
    submitForm(formName) {
      this.$refs.OldAreaEdit.submitForm(formName,this.formType,this.parentId);
    },
  },
  watch: {
    maxHeight() {
