...
<template>
    <div class="BusinessAreaEdit">
        <el-form class="formBill-One" ref="BusinessAreaEdit" :rules="rules" :inline="true" size="mini" :model="ruleForm" label-width="100px">
            ...
            <el-form-item label="默认册本号：" prop="sortNo">
                <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="ruleForm.bookNo" placeholder="默认册本"  maxlength="50" clearable ></el-input>
            </el-form-item>
            ...
            <el-form-item label="" class="desc">
                <span>所别地址/所别电话</span><span style="margin-left:10px">如泰安路39号/32532</span> 
            </el-form-item>
        </el-form>
        <!-- <div class="block">
          <span>asd</span>
        ...
        this.$refs[formName].validate((valid) => {
            if(valid){
              ...
              this.$api.fetch({
                ...
                if(type === 'add' || type==='addnext') {
                  _this.$parent.getBusinessAreaTree(); 
                }else{
                 _this.$parent.init();
                }
