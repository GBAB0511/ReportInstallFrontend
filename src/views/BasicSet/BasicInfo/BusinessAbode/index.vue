  ...
  <div class="BusinessAbode">
      ...
      <div class="bread-contain">
        ...
        <div class="bread-contain-right" v-if="EditVisible">
            <el-button size="mini" type="primary" @click="submitForm('BusinessAbodeEditForm')">保存</el-button>
      ...
      <BusinessAbodeEdit v-show="EditVisible" ref="BusinessAbodeEdit"></BusinessAbodeEdit>
      <div class="BusinessAbodeIndex" v-show="!EditVisible">
        
        <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline" @submit.native.prevent>
                  <el-form-item class="form-left">
                    <el-form-item label="营业所名称：">
                      <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  
                        v-model="tableQuery.abodeName"
                        @keyup.enter.native="search"
                        placeholder="请输入营业所名称"
...
<script>
import BusinessAbodeEdit from "./BusinessAbodeEdit"
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.common.changeTable(this, ".BusinessAbodeIndex", [
        ".BusinessAbodeIndex .toolbar",
        ".BusinessAbodeIndex .block",
      ]);
    })
  },
  methods: {
...
inputMe(e){
    ...
    // 添加按钮点击事件
      add(val) {
        ...
        console.log(this.$refs.BusinessAbodeEdit)
        if(val==='add'){
          this.$refs.BusinessAbodeEdit.editData({
            abodeNo:'',
            abodeName:'',
            sortNo:'',
            status:1,
          ...
          this.common.chargeObjectEqual(this,this.formData,'set','BusinessAbodeEdit');
        }else{
          let _this = this;
          let params = {
              "busicode": "BusinessAbodeQuery",
              "data": {
                id:val.row.id,
              },
          }
          this.$api.fetch({
            ...
            this.$refs.BusinessAbodeEdit.editData(res,'update');
            this.common.chargeObjectEqual(this,res,'set','BusinessAbodeEdit');
          })
        }
