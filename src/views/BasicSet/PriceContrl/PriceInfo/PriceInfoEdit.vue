    ...
    <div class="backfillSubmitForm">
      ...
      <el-form :inline="true" ref="PriceInfoEditForm" :rules="rules" size="mini" :model="ruleForm" label-width="120px">
        ...
        <el-form-item label="违约金策略：" prop="detailName">
          <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="ruleForm.detailName" placeholder="请输入策略名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="人口基数：" prop="personBase">
          <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model.number="ruleForm.personBase" placeholder="请输入人口基数" maxlength="1" clearable></el-input>
        </el-form-item>

        <el-form-item label="水量基数：" prop="waterBase">
          <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model.number="ruleForm.waterBase" placeholder="请输入水量基数" maxlength="1" clearable></el-input>
        </el-form-item>
      </el-form>
      ...
      <el-table stripe border v-if="tableShow" :max-height="maxHeight" :data="ruleForm.ladderlist" class="wuserInfo-table">
        ...
        <el-table-column prop="beginWater" min-width="100" label="开始水量">
          <template slot-scope="scope">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="scope.row.beginWater" type="number" maxlength="10" clearable placeholder="请输入开始水量">
            </el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="endWater" min-width="100" label="结束水量">
          <template slot-scope="scope">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="scope.row.endWater" type="number" maxlength="10" clearable placeholder="请输入结束水量">
            </el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="price" min-width="100" label="单价">
          <template slot-scope="scope">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="scope.row.price" type="number" maxlength="10" clearable step="0.0001" placeholder="请输入单价">
            </el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="coefficient" min-width="100" label="系数">
          <template slot-scope="scope">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="scope.row.coefficient" type="number" maxlength="10" clearable step="0.0001" placeholder="请输入系数">
            </el-input>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="ladderBeginMoney" min-width="100" label="阶段起始金额">
          <template slot-scope="scope">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  @input="e => input = inputMe(e)" v-model="scope.row.ladderBeginMoney" type="number" maxlength="14" clearable step="0.0001" placeholder="请输入阶段起始金额">
            </el-input>
          </template>
        </el-table-column>
