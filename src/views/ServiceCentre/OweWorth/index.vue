  ...
  <div class="owe-worth">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right">
        ...
        <el-button size="mini" type="primary" @click="sending">发送欠费催缴通知</el-button>
    ...
    <div class="oweWorthIndex">
      <div class="toolbar" style="outline:none" tabindex="0" @keydown="enterEvents($event)">
        <el-form :inline="true" size="mini" :model="tableQuery" class="demo-form-inline" label-width="80px">
          ...
          <el-form-item label="发送状态：" class="width-160">
            <el-select ref="select5" v-model="tableQuery.messageState" clearable size="mini">
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        <el-table highlight-current-row ref="table" v-if="tableShow" :max-height="maxHeight" @sort-change='sortChange' stripe border :data="tableData.list" class="change-tables-table" @selection-change="handleSelect" @row-click="handleTableCellClick" :cell-style="cellStyle">
          ...
          <el-table-column prop="stopWaterSender" label="停水发送人" min-width="120" />
          <el-table-column prop="urgeSender" label="催缴发送人" min-width="120" />
...
export default {
  ...
  created () {
    ...
    // this.dateList = [begin, this.common.date('lastMonth')]
  ...
  methods: {
    ...
    sending () {
      ...
      params = {
        busicode: "ArrearsNoticeMessageContent",
        data: {
          ...this.tableQuery,
