...
export default {
      ...
      return {
        crumbsData :{  //面包屑
            titleList:[
                ...
                {title:'问卷调查',method:()=>{window.histroy.back()}},
    ...
    mounted(){
      ...
      this.common.changeTable(this,'.ShortMessageNotification',['.ShortMessageNotification .toolbar','.ShortMessageNotification .block','.ShortMessageNotification #crumbs'])
    },
    methods: {
        init(){
