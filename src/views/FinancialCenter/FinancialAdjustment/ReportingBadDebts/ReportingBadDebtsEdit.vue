...
<template>
  <div class="ReportingBadDebtsEdit">
    <el-form
      class="formBill"
      :inline="true"
      size="mini"
    ...
    >
      ...
      <legend class="legendColumn">坏账处理信息</legend>
  ...
  methods: {
    ...
    getUserData(res) {
      ...
      this.userData = {
        ...
        statusName: res.userInfo.statusName,
