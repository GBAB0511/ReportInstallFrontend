  ...
  <div class="RedFlushing">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-if="RedFlushingVisible">
        ...
        <el-button icon="el-icon-bottom" @click="exportExcel" size="mini" type="primary" v-if="buttomShow">下载模板</el-button>
        <el-upload v-if="buttomShow" class="upload-demo" multiple   :http-request="importExcel">
    ...
    <div class="indexContent" v-if="RedFlushingVisible">
      <RedFlushingEdit :editNeedData="editNeedData" ref="childRedFlushing"></RedFlushingEdit>
    </div>
      ...
      <div class="toolbar" style="outline:none" tabindex="0" @keydown="enterEvents($event)">
        <el-form :inline="true" size="mini" :model="tableQuery" class="demo-form-inline">
          ...
          <el-form-item label="模糊查询：" class="width-200">
            <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  v-model="tableQuery.billNo" placeholder="单据编号" @keydown.enter.native="demand"></el-input>
          </el-form-item>
        ...
        >
          ...
          <el-table-column label="操作" fixed="right" width="100">
            <template slot-scope="scope">
              ...
              <el-button v-if="scope.row.processState == ''" type="text" @click="deleteRow(scope.$index, scope.row)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
  ...
  methods: {
    ...
    importExcel(file) {
      ...
      this.$api.fetch({
        ...
        this.$refs.childRedFlushing.formData.details = res
        this.$message({
            type: "success",
            message: "导入成功"
          });
