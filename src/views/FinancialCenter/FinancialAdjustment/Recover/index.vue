...
<template>
  <div class="ForFeit">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-if="ForFeitVisible">
    ...
    <div class="indexContent" v-if="ForFeitVisible">
      <ForFeitEdit :editNeedData="editNeedData" ref="childForFeit"></ForFeitEdit>
    </div>
    <div class="indexContent" v-else>
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        ...
        >
          ...
          <el-table-column prop="accountPeriod" min-width="80" label="追缴账期"></el-table-column>

          <el-table-column prop="currendPeriodWater" min-width="80" label="罚款水量" align="right"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.common.changeTable(this, ".ForFeit", [
      ".ForFeit .toolbar",
      ".ForFeit .block",
      ".ForFeit #crumbs"
    ]);
  ...
  methods: {
    ...
    closeDialog() {
      //关闭会话
      this.ForFeitVisible = false;
      this.init();
    },
    //弹出框
    submit() {
      //提交
      this.$refs.childForFeit.submit();
    },
    add() {
      this.editNeedData.busicode = "FnAddAppendAdd";
      this.editNeedData.saveType = "add";
      this.buttomShow = true;
      this.ForFeitVisible = true;
    },
    details(index, row) {
