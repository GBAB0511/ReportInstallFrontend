...
<template>
  <div class="DealingBadDebts">
    ...
    <div class="indexContent" v-if="DealingBadDebtsVisible">
      <DealingBadDebtsEdit ref="childDealingBadDebts" :editNeedData="editNeedData"></DealingBadDebtsEdit>
    </div>
    ...
    <div class="indexContent" v-else>
      ...
      <div class="kl-table" :style="{height: maxHeight + 'px'}">
        ...
        >
          ...
          <!-- <el-table-column prop="lvalue" min-width="80" label="呆账金额"></el-table-column> -->
