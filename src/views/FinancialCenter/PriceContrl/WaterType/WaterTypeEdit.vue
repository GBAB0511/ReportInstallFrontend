...
<template>
  <div class="WaterTypeEdit">
    <div>
      <el-form class="formBill-One waterTypeEditForm" ref="WaterTypeEditForm" :rules="rules" size="mini" :model="formData" label-width="100px">
        <el-form-item label="类型名称：" prop="waterTypeName">
          <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  v-model="formData.waterTypeName" maxlength="50" clearable placeholder="">
          </el-input>
        </el-form-item>
        <el-form-item label="排序号：" prop="sortNo">
          <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  v-model.number="formData.sortNo" placeholder="排序号" maxlength="6" clearable></el-input>
        </el-form-item>
