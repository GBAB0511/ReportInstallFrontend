  ...
  <div class="WaterType">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-else>
        <el-button :disabled="waterTypeNo===''" size="mini" icon="el-icon-plus" @click="add('add')" type="primary">添加</el-button>
      </div>
    </div>
    <WaterTypeEdit v-if="EditVisible" ref="WaterTypeEdit"></WaterTypeEdit>
    
    <div v-show="!EditVisible" class="company-content indexContent">
      ...
      <div class="company-right">
          <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
              <el-form-item label="类型名称：" class="width-150">
                <el-input oninput ="value=value.replace(/\ +/g,'').replace(/[\r\n]/g,'')"  v-model="tableQuery.waterTypeName" @keyup.enter.native="search" clearable placeholder="请输入类型名称">
                </el-input>
              </el-form-item>
              <el-form-item>
          ...
          <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableData.list" class="wuserInfo-table">
            ...
            <el-table-column label="操作" width="70">
              <template slot-scope="scope">
                <el-button :disabled="waterTypeNo===''" type="text" @click.native="add(scope.row)" style="font-size:12px;">编辑</el-button>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.common.changeTable(this, ".WaterType", [
        ".WaterType .toolbar",
        ".WaterType .block",
        '.WaterType .bread-contain'
      ]);
    });
  },
  methods: {
